...
**Adoption status (2026-09-21):** playbook vendored (v1.23.0) and this file reconciled; `VALUES.md` and the kickoff-as-archaeology interview (section 0.5) are still to do - ask Mikkel for a quiet moment. Recorded deviation: a single-developer project where `main` is both integration and release branch, handled by the branch rule above.
